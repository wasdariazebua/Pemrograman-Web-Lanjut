            ...
            <td align="center" valign="top" bgcolor="#FFFFFF"><br />
                ...
                <table width="700" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
                    <tr>
                        ...
                        <td width="202" bgcolor="#FFFFFF">Nama Alternatif</td>
                        <td width="261" bgcolor="#FFFFFF">Deskripsi</td>
                        <td width="77" bgcolor="#FFFFFF"><a href="add-alternatif.php">Add</a></td>
                    </tr>
                    <?php
                    $queryalternatif = mysqli_query($koneksi, "SELECT * FROM alternatif ORDER BY id_alternatif");
                    while ($dataalternatif = mysqli_fetch_array($queryalternatif)) {
                        ?>
                        <tr>
                            <td bgcolor="#FFFFFF">
                                <?php echo $dataalternatif['id_alternatif'] ?>
                            </td>
                            <td bgcolor="#FFFFFF">
                                <?php echo $dataalternatif['nama_alternatif'] ?>
                            </td>
                            <td bgcolor="#FFFFFF">
                                <?php echo $dataalternatif['deskripsi'] ?>
                            </td>
                            <td bgcolor="#FFFFFF"><a
                                    href="edit-alternatif.php?id_alternatif=<?php echo $dataalternatif['id_alternatif']; ?>">Edit</a>
                                <a
                                    href="del-alternatif.php?id_alternatif=<?php echo $dataalternatif['id_alternatif']; ?>">Del</a>
                            </td>
                        </tr>
                        <?php
                    }
